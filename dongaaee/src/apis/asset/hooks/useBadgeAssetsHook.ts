...
export const badgeAssetsQueryKey = (params?: BadgeAssets["queryParams"]) => ["v5", { url: "/v2/assets/nft/badges" }, ...(params ? [params] : [])] as const;
...
export const badgeAssetsSuspenseQueryKey = (params?: BadgeAssets["queryParams"]) => ["v5", { url: "/v2/assets/nft/badges" }, ...(params ? [params] : [])] as const;
